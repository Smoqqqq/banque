...
<div class="container-fluid princCompte py-5">
    <div class="card my-5">
        <h1>Mon compte : <div class="btn btn-outline-info disabled" style="float: right"><?= $result->role ?></div></h1><br>
        <?php
        ...
        $card_nb = $account["id"] . $account["user"] . "4589";
